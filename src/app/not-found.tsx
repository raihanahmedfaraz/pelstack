        ...
        <section className="pt-28 md:pt-36 lg:pt-44 xl:pt-60 pb-20 md:pb-28 lg:pb-40 xl:pb-52 section-reveal">
          <div className="main-container">
            <RevealAnimation delay={0.1}>
              <div className="bg-background-3 dark:bg-background-5 rounded-4xl border-10 border-white dark:border-background-9 relative overflow-hidden flex flex-col justify-center items-center py-10 md:py-20 lg:py-[100px] text-center pr-2.5">
                <RevealAnimation delay={0.2} direction="right" offset={200}>
                  <figure className="hero-gradient-2 absolute -top-[45%] sm:-top-[65%] -right-[68%] sm:-right-[48%] w-full -rotate-68 h-full opacity-70 z-0 pointer-events-none select-none">
