      ...
      <div className="main-container">
        <div className="text-center space-y-5 mb-[70px]">
          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.2}>
              <h2 className="max-w-[810px] mx-auto">Leading companies around the globe rely on pelstack.</h2>
            </RevealAnimation>
        ...
        <div className="grid grid-cols-12 max-md:gap-y-8 md:gap-8">
          <RevealAnimation delay={0.4}>
            <div className="col-span-12 md:col-span-4">
              <div className="bg-background-2 dark:bg-background-6 py-8 px-6 rounded-[20px] space-y-6 relative z-10 overflow-hidden">
                {/* bg gradient */}
                <figure className="absolute -z-10 pointer-events-none -top-[66%] -left-[60%] rotate-304 size-[410px] select-none">
          ...
          <RevealAnimation delay={0.5}>
            <div className="col-span-12 md:col-span-4">
              <div className="bg-background-2 dark:bg-background-6 py-8 px-6 rounded-[20px] space-y-6 relative z-10 overflow-hidden">
                <figure className="absolute -z-10 pointer-events-none -top-[74%] -right-[70%] rotate-175 size-[410px] select-none">
          ...
          <RevealAnimation delay={0.6}>
            <div className="col-span-12 md:col-span-4">
              <div className="bg-background-2 dark:bg-background-6 py-8 px-6 rounded-[20px] space-y-6 relative z-10 overflow-hidden">
                <figure className="absolute -z-10 pointer-events-none -top-[74%] -right-[35%] rotate-175 size-[410px] select-none">
