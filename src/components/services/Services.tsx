          ...
          {servicesData.map((service, index) => (
            <div key={service.slug} className="col-span-12 md:col-span-6 xl:col-span-4">
              <RevealAnimation delay={0.5 + index * 0.1}>
                <div className="px-6 py-8 rounded-[20px] bg-background-3 dark:bg-background-7 space-y-6 text-center grid items-center justify-center hover:-translate-y-2.5 transition-transform duration-500 ease-in-out">
