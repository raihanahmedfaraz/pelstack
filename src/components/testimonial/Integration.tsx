          ...
          <RevealAnimation delay={0.6}>
            <div className="space-y-7">
              ...
              <div className="relative max-w-[1128px] mx-auto">
                ...
                <div className="absolute left-0 top-0 h-[120px] w-[15%] md:w-[20%] bg-linear-to-r from-background-2/90 to-transparent dark:from-background-6 z-40" />
                {/* right gradient overlay  */}
                <div className="absolute right-0 top-0 h-[120px] w-[15%] md:w-[20%] bg-linear-to-l from-background-2/90 to-transparent dark:from-background-6 z-40" />
                <Marquee autoFill speed={70}>
                  <div className="flex items-center gap-5 md:gap-[34px] justify-center" role="group">
                    <figure className="size-20 md:size-[120px] bg-white dark:bg-background-6 rounded-full flex items-center justify-center ml-8 border-10 border-background-2 dark:border-background-9">
