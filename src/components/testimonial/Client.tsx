    ...
    <section>
      <RevealAnimation delay={0.2}>
        <div className="main-container text-center rounded-4xl py-[100px] z-0 bg-background-3 dark:bg-background-5 overflow-hidden relative">
          <div
            className="absolute -top-[164%] rotate-21 -left-[35%] w-full h-full -z-10 select-none pointer-events-none"
            aria-hidden="true">
          ...
          <div className="max-w-[1130px] mx-auto relative">
            <div className="absolute left-0 top-5 h-full w-[7%] bg-linear-to-r from-background-3 to-transparent dark:from-background-5 z-40" />
            <div className="absolute right-0 top-5 h-full w-[7%] bg-linear-to-l from-background-3 to-transparent dark:from-background-5 z-40" />
