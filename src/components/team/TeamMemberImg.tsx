  ...
  return (
    <RevealAnimation delay={0.2}>
      <div className="col-span-12 md:col-span-5 bg-secondary rounded-[20px] backdrop-blur-[12.5px] border border-background-4 dark:border-background-8 dark:bg-background-8 space-y-2.5 relative overflow-hidden">
        <div className="-z-100 absolute -right-[125%] -bottom-[25%] sm:-right-[85%] sm:-bottom-[15%] md:-right-[135%] md:-bottom-[25%] xl:-right-[105%] xl:-bottom-[15%] -rotate-75 size-[860px] pointer-events-none">
          <Image src={gradient} alt="gradient" />
        </div>
        <figure className="rounded-b-[20px] flex justify-center overflow-hidden bg-background-1 relative z-1 -ml-px">
          {/* gradient bg  */}
