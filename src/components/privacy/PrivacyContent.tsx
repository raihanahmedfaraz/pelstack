...
const rightsSection: ListSection = {
  ...
  items: [
    ...
    {
      content:
        'If you wish to exercise these rights, please contact us at <a href="mailto:help@pelstack.com" class="text-secondary dark:text-accent">help@pelstack.com</a>',
    },
  ],
};
        ...
        <div className="space-y-[75px] privacy-policy">
          ...
          <div className="space-y-2">
            ...
            <RevealAnimation delay={0.2}>
              <p>
                <span className="text-secondary dark:text-accent">pelstack</span> is a product operated by
                <span className="text-secondary dark:text-accent">pelstack Technologies LLC</span>. We specialize in
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-2">
              ...
              <p>
                ...
                <Link href="https://pelstack.com" className="text-secondary dark:text-accent">
                  https://pelstack.com
                </Link>
                (the &quot;Site&quot;).
              </p>
