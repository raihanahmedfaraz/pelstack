      ...
      <div className="main-container mb-[70px]">
        <RevealAnimation delay={0.1}>
          <div className="space-y-3 text-center">
            <h2>Welcome to the pelstack documentation</h2>
            <p>Find everything you need to set up, customize, and master your pelstack platform.</p>
          </div>
        </RevealAnimation>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <RevealAnimation delay={0.4}>
                <div className="bg-background-2 dark:bg-background-6 px-[42px] py-14 space-y-3 rounded-[20px] overflow-hidden relative z-10">
                  <div className="-z-100 absolute -right-[107%] -top-[110%] sm:-right-[65%] sm:-top-[105%] md:-right-[99%] md:-top-[112%] lg:-right-[79%] lg:-top-[108%] xl:-right-[62%] xl:-top-[107%] -rotate-138 size-[650px] md:[1060px] -skew-10 pointer-events-none select-none">
          ...
          <RevealAnimation delay={0.7}>
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p>Tailor pelstack to fit your business needs.</p>
              </div>
              <ul className="space-y-3 list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
                <li>
                  <Link
