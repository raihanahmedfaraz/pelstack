...
const ServiceCard = ({ stat, isFirst = false }: ServiceCardProps) => (
  <div
    ...
    <div className="transition-all duration-700 ease-in-out transform group-hover:translate-y-1">
    ...
    <p className="group-hover:text-accent/60 text-secondary/60 dark:text-accent/60 transition-all duration-700 ease-in-out transform group-hover:-translate-y-1.5 group-hover:opacity-90">
      {stat.description}
    </p>
  </div>
);
    ...
    <section className="md:py-[200px] dark:md:py-[100px] sm:py-[100px] py-[50px] bg-background-3 dark:bg-background-5">
      <RevealAnimation delay={0.1}>
        <div className="relative">
          <div className="from-background-3 dark:from-background-5 absolute top-0 left-0 z-40 h-full w-[15%] bg-linear-to-r to-transparent md:w-[20%]" />
          <div className="from-background-3 dark:from-background-5 absolute top-0 right-0 z-40 h-full w-[15%] bg-linear-to-l to-transparent md:w-[20%]" />
