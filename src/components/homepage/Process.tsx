...
import stepDark from '@public/images/homepage/step-dark.png';
import step from '@public/images/homepage/step.png';
          ...
          <div className="step-container max-w-[870px] mx-auto mb-[200px]">
            <div className="relative">
              <div>
                ...
                <div className="h-80 lg:h-[380px] w-1 mx-auto bg-stroke-2 dark:bg-stroke-6">
                  <svg
                    ref={stepLine1}
