          ...
          <div className="space-y-6">
            ...
            <RevealAnimation delay={0.4}>
              <div className="max-w-[1128px] mx-auto relative">
                <div className="absolute left-0 top-0 h-20 w-[100px] md:h-[115px] md:w-[105px] bg-linear-to-r from-background-1 to-transparent dark:from-background-6 z-40" />
                <div className="absolute right-0 top-0 h-20 w-[100px] md:h-[115px] md:w-[105px] bg-linear-to-l from-background-1 to-transparent dark:from-background-6 z-40" />
                  ...
                  <div className="flex items-center gap-2 md:gap-6! justify-center">
                    {data.slice(0, 7).map((item, index) => (
                      <figure
                        key={item.id}
                        className={cn(
                          'size-16 shrink-0 md:size-[100px] bg-white dark:bg-background-6 rounded-2xl border-10 border-background-2 dark:border-background-5 flex items-center justify-center',
            ...
            <RevealAnimation delay={0.5}>
              <div className="max-w-[984px] mx-auto relative">
                <div className="absolute left-0 top-0 h-[115px] w-[10%] md:w-[15%] bg-linear-to-r from-background-1 to-transparent dark:from-background-6 z-40" />
                <div className="absolute right-0 top-0 h-[115px] w-[10%] md:w-[15%] bg-linear-to-l from-background-1 to-transparent dark:from-background-6 z-40" />
