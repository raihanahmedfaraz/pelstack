    ...
    <section className="pt-20 md:pt-24 lg:pt-[88px] xl:pt-[100px] pb-16 md:pb-20 lg:pb-[100px] 2xl:pb-[150px]">
      <div className="max-w-[1440px] mx-auto max-lg:px-5">
        <RevealAnimation delay={0.1}>
          <div className="z-10 rounded-4xl bg-secondary dark:bg-background-6 overflow-hidden px-6 lg:px-[42px] py-14 lg:py-[72px] relative">
            <RevealAnimation delay={0.4} direction="up">
              <div className="-z-10 absolute -top-[46%] min-[400px]:-top-[50%] min-[510px]:-top-[80%] md:-top-[66%] lg:-top-[70%] -right-[22%] rotate-314 max-w-[700px] select-none pointer-events-none">
