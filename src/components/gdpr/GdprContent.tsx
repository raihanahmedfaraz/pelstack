...
const GdprContent = () => {
  ...
  const dataPurposes: ListItem[] = [
    { id: 'account-management', text: 'To create and manage your pelstack account' },
  ...
  const dataManagementItems: ListItem[] = [
    ...
    {
      id: 'data-deletion',
      text: 'To request a complete data deletion or data export, simply send an email to: help@pelstack.com',
    },
  ];
        ...
        <div className="space-y-[70px]">
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h2>pelstack and the general data protection regulation (GDPR)</h2>
              <p>
                ...
                <br />
                <br />
                This page explains how pelstack implements GDPR principles and ensures that your data is handled
          ...
          <RevealAnimation delay={0.4}>
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p>
                  At pelstack, we are fully committed to respecting your privacy. This page provides a clear overview
                  of:
                </p>
              </div>
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-3">
              ...
              <p>
                ...
                pelstack) must be transparent about what data they collect, how they use it, and how they share it — and
                ...
                residents, including pelstack.
              </p>
            </div>
          </RevealAnimation>
          {/* How pelstack Implements GDPR */}
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h3 className="text-heading-4">How pelstack Implements GDPR</h3>
              <p>
                pelstack has always prioritized user data privacy, even before GDPR came into effect. Our core practices
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                {thirdPartyServices.map((svc) => (
                  <li key={svc.id} className="flex items-center justify-start gap-2">
                    <span className="size-1.5 rounded-full inline-block bg-secondary dark:bg-accent" />
                    <p>
                      <span className="text-secondary dark:text-accent">{svc.name} </span>
                      {svc.description}
                    </p>
                  </li>
                ))}
                    ...
                    <span className="text-tagline-1 text-secondary/60 dark:text-accent/60">
                      {item.id === 'data-deletion' ? (
                        <>
                          ...
                          <span className="text-secondary dark:text-accent">help@pelstack.com</span>
                        </>
                      ) : (
                        item.text
                      )}
