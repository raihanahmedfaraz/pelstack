import vision1Img from '@public/images/about/vision-1.png';
import vision2Img from '@public/images/about/vision-2.png';
import vision3Img from '@public/images/about/vision-3.png';
      ...
      <div className="main-container space-y-14 md:space-y-[70px]">
        <div className="space-y-3 text-center max-w-[780px] mx-auto">
          ...
          <RevealAnimation delay={0.3}>
            <h2>pelstack is defining the future landscape of business.</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
            <p>
              In a rapidly evolving digital world, pelstack stands at the forefront of innovation, transforming how
