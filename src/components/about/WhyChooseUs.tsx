import circleImg from '@public/images/about/circle.png';
import aboutDecentralization2Img from '@public/images/about/about-decentralization-2.svg';
import aboutDecentralizationDark2Img from '@public/images/about/about-decentralization-dark-2.svg';
import profitChartImg from '@public/images/about/profit-chart.png';
import profitDarkChartImg from '@public/images/about/profit-dark-chart.png';
...
const WhyChooseUs = ({ className = '' }: WhyChooseUsProps) => {
  return (
    <section className={`pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[100px] overflow-hidden ${className}`}>
      <div className="main-container">
        <div className="flex flex-col md:flex-row justify-between gap-y-10 gap-x-12 items-center">
          ...
          <div className="relative max-w-[460px] min-h-[400px] md:min-h-[450px] lg:min-h-[500px] xl:min-h-[558px] max-h-[598px] w-full h-full bg-linear-[156deg,#FFF_32.92%,#83E7EE_91%] dark:bg-linear-[156deg,#070B10_32.92%,#C6F56F_91%] rounded-[20px]">
            <RevealAnimation delay={0.3}>
